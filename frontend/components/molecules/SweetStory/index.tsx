  ...
  return (
    <div className='container mx-auto px-4 py-16'>
      ...
      <div className='relative'>
        ...
        <div className='absolute left-1/2 transform -translate-x-1/2 h-[100%] w-1 bg-[#960018] -top-10 -bottom-10 hidden lg:block'></div>
        ...
        {storyEvents.map((event, index) => (
          <Fragment key={index}>
            ...
            >
              ...
              >
                ...
                <motion.div
                  ...
                  className='w-full lg:w-[500px] bg-white p-8 rounded-lg shadow-lg border-8 border-[#960018] z-10 order-1 lg:order-none'
                >
                  <h3 className='text-3xl font-bold mb-4 text-[#960018]'>
                    {event.title}
                  </h3>
            ...
            {index < storyEvents.length - 1 && (
              <div className='absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-[#960018] rounded-full z-20 mb-16 hidden lg:block'></div>
            )}
          </Fragment>
        ))}
      </div>
